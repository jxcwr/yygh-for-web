<template>
  <div class="app-container">
     <el-form label-width="120px" :rules="xxx" :model="hospsetData" ref="vvv">

       <el-form-item label="医院名称" prop="hosname">
        <el-input v-model="hospsetData.hosname"/>
      </el-form-item>
      <el-form-item label="医院编号">
        <el-input v-model="hospsetData.hoscode"/>
      </el-form-item>
      <el-form-item label="api地址">
        <el-input v-model="hospsetData.apiUrl"/>
      </el-form-item>
      <el-form-item label="联系人">
        <el-input v-model="hospsetData.contactsName"/>
      </el-form-item>
      <el-form-item label="电话" prop="contactsPhone">
        <el-input v-model="hospsetData.contactsPhone"/>
      </el-form-item>
      <el-form-item>
...
export default {
  ...
  created(){
    ...
    if(this.$route.params && this.$route.params.id){
       ...
       hospset.detail(1).then(resp=>{

         this.hospsetData= resp.data.list
       })
    }
