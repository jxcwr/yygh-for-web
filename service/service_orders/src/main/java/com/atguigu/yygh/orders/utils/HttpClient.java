        ...
        try {
            if (isHttps) {
                if (isCert) {
                    ...
                    FileInputStream inputStream = new FileInputStream(new File("D:\\JAVA-Project\\hospital\\yygh_parent\\service\\service_orders\\src\\main\\resources\\apiclient_cert.p12"));
